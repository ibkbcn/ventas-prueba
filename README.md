...
![DAX](https://img.shields.io/badge/DAX-Expert-orange?style=flat)
...
La tabla `transaction` actúa como tabla de hechos central, conectada a `credit_card`, `company`, `user` y `products` a través de la tabla intermedia `comprados`. Esta arquitectura permite análisis por producto sin duplicar filas de transacción.
